"""
ResNet-50 Transfer Learning Model for Multi-label Chest X-ray Classification.
Uses ImageNet pre-trained weights, replaces the final FC layer with a 14-class head.
"""
...
class ResNetChestXray(nn.Module):
    ...
    def __init__(
        ...
        # ── Strip original classifier, keep feature extractor ─────────────
