"""
Hospital Node — Local Model Training
Each hospital trains independently on its own data partition and returns
updated model weights (no raw data leaves the hospital).
"""
